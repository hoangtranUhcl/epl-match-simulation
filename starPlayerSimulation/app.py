...
def predict():
    ...
    try:
        ...
        # Log the input to predict_match
        logger.info(f"Calling predict_match with: home_team={data['home_team']}, away_team={data['away_team']}, excluded_players={excluded_players}")
        ...
        logger.info(f"Prediction probabilities - Home Win: {result['home_win_prob']}%, Draw: {result['draw_prob']}%, Away Win: {result['away_win_prob']}%")
